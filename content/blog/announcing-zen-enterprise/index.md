...
<div class="feature-illustrations">
  <img src="policies.jpg" alt="Image with the text: 'Define flexible policies. Compatible with all popular filter list formats.' and a screenshot of Zen Dashboard's Policies page." loading="lazy" />
  <img src="endpoint.jpg" alt="Image with the text: 'Deploy to endpoints in minutes. Agent available on Windows, macOS and Linux coming soon.' and a screenshot of a PowerShell window script installing Zen Agent." loading="lazy" />
</div>

- __Centralized policy management__<br />
...
- __Fast, local protection on every endpoint__<br />
...
- __Network performance improvements__<br />
...
If you'd like a walkthrough or have questions about integration, deployment, or policies, we're here to help – just reach out via [contact@irbis.sh](mailto:contact@irbis.sh) or [community Discord]({{% param discordInviteLink %}}).
